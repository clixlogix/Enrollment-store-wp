...
if (!function_exists('trx_utils_get_privacy_text')) {
    function trx_utils_get_privacy_text() {
        ...
        if(function_exists('insurance_ancora_get_theme_option'))
            $privacy_text = insurance_ancora_get_theme_option( 'privacy_text' );
...
if (!function_exists('insurance_ancora_add_fields_in_user_inform')) {
    function insurance_ancora_add_fields_in_user_inform( $user ) {
        ?>
            ...
            if (is_array($social_list) && count($social_list) > 0) {
                foreach ($social_list as $soc) {
                    ...
                    if (!empty($sn)) {
                        ?>
                        <tr>
                            <th><label for="user_<?php echo esc_attr($sn); ?>"><?php insurance_ancora_show_layout(insurance_ancora_strtoproper($sn)); ?>:</label></th>
                            <td><input type="text" name="user_<?php echo esc_attr($sn); ?>" id="user_<?php echo esc_attr($sn); ?>" size="55" value="<?php echo esc_attr(get_the_author_meta('user_'.($sn), $user->ID)); ?>" />
                                <span class="description"><?php echo sprintf(esc_html__('Please, enter your %s link', 'trx_utils'), insurance_ancora_strtoproper($sn)); ?></span>
                            </td>
                        </tr>
                        <?php
                    }
...
if (!function_exists('insurance_ancora_save_fields_in_user_inform')) {
    function insurance_ancora_save_fields_in_user_inform( $user_id ) {
