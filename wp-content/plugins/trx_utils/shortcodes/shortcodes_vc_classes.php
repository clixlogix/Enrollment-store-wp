...
// Shortcode template
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCode' ) ) {
	abstract class Insurance_Ancora_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCodeSingle' ) ) {
	abstract class Insurance_Ancora_VC_ShortCodeSingle extends Insurance_Ancora_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCodeAlone' ) ) {
	abstract class Insurance_Ancora_VC_ShortCodeAlone extends Insurance_Ancora_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCodeContainer' ) ) {
	abstract class Insurance_Ancora_VC_ShortCodeContainer extends Insurance_Ancora_VC_ShortCode {
...
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCodeCollection' ) ) {
	abstract class Insurance_Ancora_VC_ShortCodeCollection extends Insurance_Ancora_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCodeItem' ) ) {
	abstract class Insurance_Ancora_VC_ShortCodeItem extends Insurance_Ancora_VC_ShortCode {
...
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCodeColumns' ) ) {
	abstract class Insurance_Ancora_VC_ShortCodeColumns extends Insurance_Ancora_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( !class_exists('Insurance_Ancora_VC_ShortCodeAccordion') ) {
	abstract class Insurance_Ancora_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class Insurance_Ancora_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( !class_exists('Insurance_Ancora_VC_ShortCodeToggles') ) {
	abstract class Insurance_Ancora_VC_ShortCodeToggles extends Insurance_Ancora_VC_ShortCodeAccordion {}
	abstract class Insurance_Ancora_VC_ShortCodeTogglesItem extends Insurance_Ancora_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'Insurance_Ancora_VC_ShortCodeTabs' ) ) {
	abstract class Insurance_Ancora_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class Insurance_Ancora_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
