...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by InsuranceAncora
	 * @var $inverse	- added by InsuranceAncora
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by InsuranceAncora:
	// Color scheme
	if ($scheme && !insurance_ancora_param_is_off($scheme) && !insurance_ancora_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !insurance_ancora_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add InsuranceAncora color scheme in the row
	if ($scheme && !insurance_ancora_param_is_off($scheme) && !insurance_ancora_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
