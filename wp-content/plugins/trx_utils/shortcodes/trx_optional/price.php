...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('insurance_ancora_sc_price_theme_setup')) {
	add_action( 'insurance_ancora_action_before_init_theme', 'insurance_ancora_sc_price_theme_setup' );
	function insurance_ancora_sc_price_theme_setup() {
		add_action('insurance_ancora_action_shortcodes_list', 		'insurance_ancora_sc_price_reg_shortcodes');
		if (function_exists('insurance_ancora_exists_visual_composer') && insurance_ancora_exists_visual_composer())
			add_action('insurance_ancora_action_shortcodes_list_vc','insurance_ancora_sc_price_reg_shortcodes_vc');
	}
}
...
if (!function_exists('insurance_ancora_sc_price')) {	
	function insurance_ancora_sc_price($atts, $content=null){	
		...
		return apply_filters('insurance_ancora_shortcode_output', $output, 'trx_price', $atts, $content);
	}
	add_shortcode('trx_price', 'insurance_ancora_sc_price');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'insurance_ancora_sc_price_reg_shortcodes' ) ) {
	function insurance_ancora_sc_price_reg_shortcodes() {
	
		insurance_ancora_sc_map("trx_price", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'insurance_ancora_sc_price_reg_shortcodes_vc' ) ) {
	function insurance_ancora_sc_price_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Price extends Insurance_Ancora_VC_ShortCodeSingle {}
	}
}
?>