...
if ( !function_exists( 'insurance_ancora_template_news_portfolio_theme_setup' ) ) {
	add_action( 'insurance_ancora_action_before_init_theme', 'insurance_ancora_template_news_portfolio_theme_setup', 1 );
	function insurance_ancora_template_news_portfolio_theme_setup() {
		insurance_ancora_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'insurance-ancora'),
...
// Template output
if ( !function_exists( 'insurance_ancora_template_news_portfolio_output' ) ) {
	function insurance_ancora_template_news_portfolio_output($post_options, $post_data) {
