...
if ( !function_exists( 'insurance_ancora_template_services_1_theme_setup' ) ) {
	add_action( 'insurance_ancora_action_before_init_theme', 'insurance_ancora_template_services_1_theme_setup', 1 );
	function insurance_ancora_template_services_1_theme_setup() {
		insurance_ancora_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'insurance-ancora'),
			'thumb_title'  => esc_html__('Medium image (crop)S1', 'insurance-ancora'),
			'w'		 => 370,
			'h'		 => 270
		));
	}
...
// Template output
if ( !function_exists( 'insurance_ancora_template_services_1_output' ) ) {
	function insurance_ancora_template_services_1_output($post_options, $post_data) {
