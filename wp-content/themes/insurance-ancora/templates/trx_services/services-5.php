...
if ( !function_exists( 'insurance_ancora_template_services_5_theme_setup' ) ) {
	add_action( 'insurance_ancora_action_before_init_theme', 'insurance_ancora_template_services_5_theme_setup', 1 );
	function insurance_ancora_template_services_5_theme_setup() {
		insurance_ancora_add_template(array(
			'layout' => 'services-5',
			'template' => 'services-5',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 5/', 'insurance-ancora'),
...
// Template output
if ( !function_exists( 'insurance_ancora_template_services_5_output' ) ) {
	function insurance_ancora_template_services_5_output($post_options, $post_data) {
