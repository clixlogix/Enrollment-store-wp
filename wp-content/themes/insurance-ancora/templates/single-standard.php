...
if ( !function_exists( 'insurance_ancora_template_single_standard_theme_setup' ) ) {
	add_action( 'insurance_ancora_action_before_init_theme', 'insurance_ancora_template_single_standard_theme_setup', 1 );
	function insurance_ancora_template_single_standard_theme_setup() {
		insurance_ancora_add_template(array(
			'layout' => 'single-standard',
			'mode'   => 'single',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single standard', 'insurance-ancora'),
...
// Template output
if ( !function_exists( 'insurance_ancora_template_single_standard_output' ) ) {
	function insurance_ancora_template_single_standard_output($post_options, $post_data) {
