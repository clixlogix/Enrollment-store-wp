...
if ( !function_exists( 'insurance_ancora_template_testimonials_2_theme_setup' ) ) {
	add_action( 'insurance_ancora_action_before_init_theme', 'insurance_ancora_template_testimonials_2_theme_setup', 1 );
	function insurance_ancora_template_testimonials_2_theme_setup() {
		insurance_ancora_add_template(array(
			'layout' => 'testimonials-2',
			'template' => 'testimonials-2',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 2/', 'insurance-ancora')
		));
	}
}

// Template output
if ( !function_exists( 'insurance_ancora_template_testimonials_2_output' ) ) {
	function insurance_ancora_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
